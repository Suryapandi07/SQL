/*======================================================
	Section 5: Create a new Database and Datamodel    
========================================================*/
...
-- Syntax: ALTER TABLE <table name> ADD PRIMARY KEY (<primary key column>);
...
-- ALTER TABLE <table name> ADD CONSTRAINT <foriegn key name> FORIEGN KEY (<column in the child table>)
-- REFERENCES <parent table name> (<parent table column name>);	
-- foreign key name format: fk_tablename_columnname
...
-- Constraint names helps us to manage the Keys
-- ALTER TABLE customers DROP CONSTRAINT fk_customers_salesRepEmployeeNumber;
...
CREATE TABLE payments (
  ...
  CONSTRAINT fk_payments_customerNumber FOREIGN KEY (customerNumber) REFERENCES customers (customerNumber)
);
...
CREATE TABLE orders (
  ...
  CONSTRAINT fk_orders_customerNumber FOREIGN KEY (customerNumber) REFERENCES customers (customerNumber)
); 
...
CREATE TABLE orderdetails (
  orderNumber int NOT NULL,
  productCode varchar(15) NOT NULL, -- Create products table first
...
('Paris','+33 14 723 4404','43 Rue Jouffroy D\'abbans',NULL,NULL,'France','75017','EMEA'),
('Tokyo','+81 33 224 5000','4-1 Kioicho',NULL,'Chiyoda-Ku','Japan','102-8578','Japan'),
('Sydney','+61 2 9264 2451','5-11 Wentworth Avenue','Floor #2',NULL,'Australia','NSW 2010','APAC'),
('London','+44 20 7877 2041','25 Old Broad Street','Level 7',NULL,'UK','EC2N 1HN','EMEA');
